...
public class NavigationMenu {
	...
	public List getMenuItems() {
        ...
        NavigationMenuItem plandateMenu = createMenuNavigationItem("Plandaten", null);
        menu.add(plandateMenu);
        
        NavigationMenuItem kategorieMenu = createMenuNavigationItem("Kategorien", null);
        menu.add(kategorieMenu);
        kategorieMenu.add(createMenuNavigationItem("Übersicht", "kategorieUebersicht", "/pages/kategorie/uebersicht.jsp"));
        
        kategorieMenu.add(createMenuNavigationItem("Neu", "neueKategorie", "/pages/kategorie/neu.jsp"));
        
        NavigationMenuItem mandantMenu = createMenuNavigationItem("Mandanten", null);
        menu.add(mandantMenu);
        mandantMenu.add(createMenuNavigationItem("Übersicht", "mandantUebersicht", "/pages/mandant/uebersicht.jsp"));
    ...
    private static NavigationMenuItem createMenuNavigationItem(String label, String action) {
    ...
    private static NavigationMenuItem createMenuNavigationItem(String label, String action, String viewId) {
        NavigationMenuItem item = new NavigationMenuItem(label, action);
        item.setActionListener("#{menu.actionListener}");
        item.setValue(label);
